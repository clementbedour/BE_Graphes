...
public class DijkstraAlgorithmV2 extends ShortestPathAlgorithm {

    private final List<Node> List_Node;

    public DijkstraAlgorithmV2(ShortestPathData data,List<Node> List) {
        super(data);
        this.List_Node = List;
    }
